...
function formatText(str) {
  ...
  */
  ...
  function excercise2alternative () {
    return "hello"
  }
  ...
  */
  function myFunction(callback, string) {
    // vi referer til callback og string, som parametere
    callback(string)
  }
  
  //myFunction(console.log, "Hei") // her kaller vi console.log, og "hei" for argumenter
  myFunction(dispText, "Hei")
  ...
  */
  ...
  myFunction((txt) => dispText(txt), "Hallo 2")
  ...
  */
  ...
  //forHver(fiveWords, console.log)
  //forHver(threeFruits, dispText)
  ...
  */
  ...
  threeFruits.forEach(function(element) {
    dispText(element)
  })
  ...
  */
  ...
  /* const newNums = nums.map(num => {
    if (num > 2) return "Larger than two"
  }) */
  
  /* const newNums = nums.reduce(function(accumulator, currentValue) {
    //accumulator.push(currentValue * 2)
    //return accumulator
    if (currentValue > 2) return [...accumulator, currentValue]// "Larger than two"
    return accumulator
  }, []) // [] er initialValue */
  ...
  const someText = nums.reduce(function(accumulator, currentValue) {
    return accumulator + "<h3>" + currentValue + "</h3>"
  }, "")
  ...
  */
  ...
  days.forEach(day => {
    ...
    element.style = "min-height: 1rem; "
    element.addEventListener("click", () => console.log(`Your lucky number is ${Math.floor(Math.random()*100)}`))
